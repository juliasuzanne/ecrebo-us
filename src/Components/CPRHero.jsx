        ...
        <div className="row">
          <div className="hero-content col-lg-6 col-md-12">
            ...
            <p className="descriptiontext cpr-text">
              Add personalized QR codes to your paper receipts to cost-effectively acquire and activate loyalty app
              users.
            </p>
            <p className="descriptiontext cpr-text">
          ...
          <div className="col-lg-6 col-md-12 hero-img-cpr"></div>
